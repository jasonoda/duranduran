...
export class UI {
    ...
    load() {
        ...
        for(var i=1; i<=72; i++){
            imagePaths.push( "./src/img/sk/sk_"+i+".png" )
         }
    ...
    build(){
        ...
        this.skeliton = new PIXI.Sprite(this.s.sk_1);
        this.skeliton.anchor.x=.5;
        this.skeliton.anchor.y=1;
        this.skeliton.scale.x=this.skeliton.scale.y=2.7
        this.skeliton.y=2040;
        this.skeliton._zIndex=50;
        this.baseCont.addChild(this.skeliton);

        this.skAni = [
            this.s.sk_1, this.s.sk_2, this.s.sk_3, this.s.sk_4, this.s.sk_5, this.s.sk_6, this.s.sk_7, this.s.sk_8, this.s.sk_9, this.s.sk_10, 
            this.s.sk_11, this.s.sk_12, this.s.sk_13, this.s.sk_14, this.s.sk_15, this.s.sk_16, this.s.sk_17, this.s.sk_18, this.s.sk_19, this.s.sk_20, 
            this.s.sk_21, this.s.sk_22, this.s.sk_23, this.s.sk_24, this.s.sk_25, this.s.sk_26, this.s.sk_27, this.s.sk_28, this.s.sk_29, this.s.sk_30, 
            this.s.sk_31, this.s.sk_32, this.s.sk_33, this.s.sk_34, this.s.sk_35, this.s.sk_36, this.s.sk_37, this.s.sk_38, this.s.sk_39, this.s.sk_40, 
            this.s.sk_41, this.s.sk_42, this.s.sk_43, this.s.sk_44, this.s.sk_45, this.s.sk_46, this.s.sk_47, this.s.sk_48, this.s.sk_49, this.s.sk_50, 
            this.s.sk_51, this.s.sk_52, this.s.sk_53, this.s.sk_54, this.s.sk_55, this.s.sk_56, this.s.sk_57, this.s.sk_58, this.s.sk_59, this.s.sk_60, 
            this.s.sk_61, this.s.sk_62, this.s.sk_63, this.s.sk_64, this.s.sk_65, this.s.sk_66, this.s.sk_67, this.s.sk_68, this.s.sk_69, this.s.sk_70, 
            this.s.sk_71, this.s.sk_72
        ];
    ...
    makeSparkles(){
        ...
        //     gsap.to( this.glows2[i].position, { x: this.e.u.nran(1000), y: 1812-this.e.u.ran(2000), duration: dur, delay: del, ease: "sine.out"});
